...
function MilitaryVesselLayer({ 
    ...
    const fetchMilitaryVessels = useCallback((bounds: ViewportBounds) => {
        ...
        fetch(`${api_url}/v1/vessels/position/all?${params}`)
            ...
            .then(data => setMilitaryVessels(data))
            .catch(error => console.error('Error fetching Military Vessels:', error));
    }, []);
    ...
    useEffect(() => {
        ...
        debounceTimeoutRef.current = setTimeout(() => {
            if (currentViewportBoundsRef.current) {
                fetchMilitaryVessels(currentViewportBoundsRef.current);
            }
    ...
    }, [visible, viewportBounds, fetchMilitaryVessels]);
...
export default MilitaryVesselLayer;